...
namespace 爱校园
{
    public partial class Form_main : Form
    {
        ...
        private void start_load(object sender, EventArgs e)
        {
            ...
            checkBox_save_account.Checked = Settings1.Default.save_account;
            textBox_account.Text = Settings1.Default.user_name;
            acheckBox_save_pwd.Checked = Settings1.Default.save_pwd;
            textBox_pwd.Text = Settings1.Default.password;
            label_auth_sms.Text = Settings1.Default.auth_sms;
            }
        ...
        {
            if (!(radioButton_login_pwd.Checked == true||radioButton_login_sms.Checked==true))
            {
                MessageBox.Show("请先选择登录方式！");
            }
            else
            {
            ...
            else
            {
                ...
                if (result == DialogResult.OK)
                {
                    ...
                    if (xx[15] == "短信密码下发成功�?}")
                    {
                        ...
                        Settings1.Default.auth_sms = label_auth_sms.Text;
                    }
